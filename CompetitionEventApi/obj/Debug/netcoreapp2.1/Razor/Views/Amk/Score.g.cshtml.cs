#pragma checksum "D:\Projects\CompetitionEventApi\CompetitionEventApi\Views\Amk\Score.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "42ec7bbd83a972d146457220662fff9fb2c6eb12"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"42ec7bbd83a972d146457220662fff9fb2c6eb12", @"/Views/Amk/Score.cshtml")]
...
");
        ...
        <div class=""row"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "999fe8e599594854a110ea5a1a20b90d", async() => {
                    ...
                    axios.get(_siteUrl + 'api/competitions')
                        .then(response => {
                            if (mainComeptitionId == 1 || mainComeptitionId == 2) {
                                ...
                                this.competitions = response.data.filter(function (e) {
            ");
            WriteLiteral(@"                        return e.id == mainComeptitionId;
                                })
                            }
                        })
                        .catch(e => {
            ...
            save: function (e) {
                ...
                var chkMainCompScore = this.competitionScores.filter(function (e) {
                    return (saveModel.CompetitionId == 7 || saveModel.CompetitionId == 8 || saveModel.CompetitionId == 9)
                        && (e.competitionId");
            WriteLiteral(@" == 7 || e.competitionId == 8 || e.competitionId == 9); //begginer, pro, extreme
                })
