#pragma checksum "D:\Projects\CompetitionEventApi\CompetitionEventApi\Views\Amk\Scoring.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e1f208db4ca20a792f7c0038ebd0b76999daba2a"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e1f208db4ca20a792f7c0038ebd0b76999daba2a", @"/Views/Amk/Scoring.cshtml")]
            ...
            <table class=""table table-bordered table-striped push-top-20"">
                ...
                <tbody>
                    <tr v-bind:key=""index"" v-for=""(competitionApplication,index) in competitionApplications"">
                        ...
                        <td>{{competitionApplication.competition.");
...
<script>
    var app = new Vue({
        ...
        computed: {
            ...
            //        return item.r");
            WriteLiteral(@"elatedCompetitionId == 0;
            //    })
        ...
        methods: {
            search: function () {
                ...
                var searchedApps = this.competitionApplicationsOrigina");
            WriteLiteral(@"l.filter(function (e) {
