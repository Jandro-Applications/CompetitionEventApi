#pragma checksum "D:\Projects\CompetitionEventApi\CompetitionEventApi\Views\Amk\Score.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d3816a06a9b441c7c606258334bf5eb685c3a7c3"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d3816a06a9b441c7c606258334bf5eb685c3a7c3", @"/Views/Amk/Score.cshtml")]
                ...
                <div class=""form-group row"">
                    ...
                    <div class=""col-sm-10"">
                        <select class=""form-control"" id=""competitions"" v-model=""scoreSaveViewModel.CompetitionId"">
                            ");
            EndContext();
            BeginContext(1890, 155, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "db324657a5ba43589c4603c4c6063e0c", async() => {
    ...
    var app = new Vue({
        ...
        data() {
            return {
                ...
                mainCompetitionId: 0,
   ");
            WriteLiteral(@"             scoreSaveViewModel: {},
                competitions: [],
                msg:''
            }
        },
        created() {
            ...
            axios.get('http://show.amkbilogora.hr/api/scores/' + getUrlVars()[""Id""])
                .then(response => {
                    ...
                    axios.get('http://show.amkbilogora.hr/api/competitions')
                        .then(response => {
                            if (mainComeptitionId == 1 || mainComeptitionId == 2) {
                                ...
                                this.competitions = response.data.fil");
            WriteLiteral(@"ter(function (e) {
        ...
        methods: {
           ...
           ");
            WriteLiteral(@"             && (e.competitionId == 7 || e.competitionId == 8 || e.competitionId == 9); //begginer, pro, extreme
                })
                ...
                axios({
                    method: 'post',
                    url: 'http://show.amkbilogora.hr/api/scores/',
                    data: saveModel
                }).then(response => {
                    this.msg = ""Spremljeno"";
                    app.$forceUpdate();
